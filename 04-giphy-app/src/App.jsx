...
function App () {
  ...
  useEffect(() => {
    fetch(`https://api.giphy.com/v1/gifs/trending?api_key=MNhdy5Hq4XDyh91F8bE4i36f6vi5u4U2&limit=25&offset=0&rating=g&bundle=messaging_non_clips`)
      .then(response => response.json())
      .then((results) => {
        console.log(results.data)
        setGifs(results.data)
...
//Las llamadas a la API se hacen normalmente a través de UseEffect
//Se usara useEffect con un arreglo de dependencias vacio para que se ejecute una sola vez
  return (
    <>
